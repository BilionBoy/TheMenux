...
class PedidosTest < ApplicationSystemTestCase
  ...
  test "should create pedido" do
    ...
    fill_in "Endereco entrega", with: @pedido.endereco_entrega
    fill_in "Estabelecimento", with: @pedido.estabelecimento_id
    fill_in "Metodo entrega", with: @pedido.metodo_entrega
    fill_in "Status", with: @pedido.status
    fill_in "Total preco", with: @pedido.total_preco
