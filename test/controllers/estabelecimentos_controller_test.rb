...
class EstabelecimentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estabelecimento" do
    assert_difference("Estabelecimento.count") do
      post estabelecimentos_url, params: { estabelecimento: { nome: @estabelecimento.nome, redes_sociais: @estabelecimento.redes_sociais, tema: @estabelecimento.tema, tipo: @estabelecimento.tipo, user_id: @estabelecimento.user_id } }
    end
  ...
  test "should update estabelecimento" do
    patch estabelecimento_url(@estabelecimento), params: { estabelecimento: { nome: @estabelecimento.nome, redes_sociais: @estabelecimento.redes_sociais, tema: @estabelecimento.tema, tipo: @estabelecimento.tipo, user_id: @estabelecimento.user_id } }
