...
class AvaliacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avaliacao" do
    assert_difference("Avaliacao.count") do
      post avaliacaos_url, params: { avaliacao: { comentario: @avaliacao.comentario, nota: @avaliacao.nota, produto_id: @avaliacao.produto_id } }
    end
  ...
  test "should update avaliacao" do
    patch avaliacao_url(@avaliacao), params: { avaliacao: { comentario: @avaliacao.comentario, nota: @avaliacao.nota, produto_id: @avaliacao.produto_id } }
