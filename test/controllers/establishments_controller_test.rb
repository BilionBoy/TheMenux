...
class EstablishmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create establishment" do
    assert_difference("Establishment.count") do
      post establishments_url, params: { establishment: { name: @establishment.name, slug: @establishment.slug, social_links: @establishment.social_links, theme: @establishment.theme, type: @establishment.type, user_id: @establishment.user_id } }
    end
  ...
  test "should update establishment" do
    patch establishment_url(@establishment), params: { establishment: { name: @establishment.name, slug: @establishment.slug, social_links: @establishment.social_links, theme: @establishment.theme, type: @establishment.type, user_id: @establishment.user_id } }
