class EstablishmentsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to establishments_path, status: :see_other, notice: "Establishment was successfully destroyed." }
  ...
  private
    ...
    def establishment_params
      params.require(:establishment).permit(:user_id, :name, :slug, :type, :theme, :social_links)
    end
end
